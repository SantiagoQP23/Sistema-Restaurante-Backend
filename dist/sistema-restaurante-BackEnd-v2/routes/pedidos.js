...
router.put("/editar/:idPedido/estado", (0, express_validator_1.check)('idPedido').custom(db_validators_1.esPedidoValido), (0, express_validator_1.check)('idPedido').custom(db_validators_1.esPedidoEntregado), validar_campos_1.validarCampos, pedidos_1.actualizarEstadoPedido);
// Eliminar un pedido por su id
router.delete("/eliminar/:idPedido", (0, express_validator_1.check)('idPedido').custom(db_validators_1.esPedidoValido), (0, express_validator_1.check)('idPedido').custom(db_validators_1.esPedidoFinalizado), validar_campos_1.validarCampos, pedidos_1.eliminarPedido);
